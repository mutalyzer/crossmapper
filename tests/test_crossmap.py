from mutalyzer_crossmapper import Crossmap, Locus, MultiLocus
from mutalyzer_crossmapper.crossmapper import _offsets
...
def test_MultiLocus_degenerate():
    ...
    _test_degenerate_equal(
        multi_locus.to_coordinate, [(1, -1, -1), (-1, 0, -1)])
    _test_degenerate_equal(
        multi_locus.to_coordinate, [(22, 1, 1), (23, 0, 1)])
...
#
#
#def test_Crossmap_coding_utr_intron_inverted_degenerate():
